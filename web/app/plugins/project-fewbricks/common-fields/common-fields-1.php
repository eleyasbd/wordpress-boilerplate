...
$fewbricks_common_fields['vertical_alignment'] = new \fewbricks\acf\fields\select('Vertical alignment',
    'vertical_alignment', '1702122129a', [
        'choices' => [ // keys corresponds to Bootstraps valign classes
            'start' => 'Top',
            'center' => 'Middle',
            'end' => 'Bottom'
        ],
...
$fewbricks_common_fields['color_1'] = new \fewbricks\acf\fields\select('Color scheme',
    'color_scheme', '1702211452y', [
        'choices' => [
            'black' => 'Black',
            'gray' => 'Gray',
            'white' => 'White',
