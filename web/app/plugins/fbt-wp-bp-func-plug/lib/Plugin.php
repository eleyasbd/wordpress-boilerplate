...
class Plugin {
	 ...
	 */
	protected $pluginname = 'fbt-wp-bp-func-plug';
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action('admin_footer', $plugin_admin, 'add_custom_acf_js');
		//$this->loader->add_action('init', $plugin_admin, 'remove_admin_features', 100);

		(new LoginForm())->define_hooks();
	...
	private function define_frontend_hooks() {
		...
		(new Frontend\CookieAlert())->define_hooks();
